 ...
 * $Author: steves $
 * $Locker:  $
 * $Date: 2007/03/07 18:59:34 $
 * $Id: orpgrda.h,v 1.34 2007/03/07 18:59:34 steves Exp $
 * $Revision: 1.34 $
 * $State: Exp $
 * $Log: orpgrda.h,v $
...
#define	CRDA_SB_ENAB		29	/*				*/
#define	CRDA_SB_DIS		30	/*				*/
#define CRDA_SR_ENAB		31	/*  				*/
#define CRDA_SR_DISAB		32	/*  				*/
...
int	ORPGRDA_set_previous_state ();
