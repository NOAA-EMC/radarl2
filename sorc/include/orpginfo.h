 ...
 * $Author: cmn $
 * $Locker:  $
 * $Date: 2007/09/19 15:35:09 $
 * $Id: orpginfo.h,v 1.74 2007/09/19 15:35:09 cmn Exp $
 * $Revision: 1.74 $
 * $State: Exp $
 */
/**************************************************************************
...
*/
typedef enum {ORPGINFO_STATEFL_FLG_TESTMODE = 0x01,
...
/*
 ...
 ORPGINFO_STATEFL_RPGALRM_SPARE29	29 	Spare
...
typedef enum {ORPGINFO_STATEFL_RPGALRM_NONE     = 0x00000001,    /* 31 */
              ...
              ORPGINFO_STATEFL_RPGALRM_FLACCFL  = 0x00040000,    /* 17 */
              ORPGINFO_STATEFL_RPGALRM_DISTRI   = 0x00080000,  	 /* 12 */
              ORPGINFO_STATEFL_RPGALRM_WBFAILRE = 0x00100000   	 /* 11 */
