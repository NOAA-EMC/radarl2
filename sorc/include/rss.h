 ...
 * $Author: jing $
 * $Locker:  $
 * $Date: 2007/07/30 20:14:52 $
 * $Id: rss.h,v 1.32 2007/07/30 20:14:52 jing Exp $
 * $Revision: 1.32 $
 * $State: Exp $
 * $Log: rss.h,v $
 * Revision 1.32  2007/07/30 20:14:52  jing
 * Update
 *
...
typedef struct {		/* struct for variable size argument (type v) 
    ...
    char free_this;		/* This struct needs to be freed if not NULL */
    char free_data;		/* "data" needs to be freed if not NULL */
