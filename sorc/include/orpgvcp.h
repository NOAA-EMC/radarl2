 ...
 * $Author: cmn $
 * $Locker:  $
 * $Date: 2007/11/20 16:44:44 $
 * $Id: orpgvcp.h,v 1.18 2007/11/20 16:44:44 cmn Exp $
 * $Revision: 1.18 $
 * $State: Exp $
 */
...
#define ORPGVCP_RDA_DEFINED_VCP			  1
#define ORPGVCP_RPG_DEFINED_VCP			  2
#define ORPGVCP_VCP_MASK                          0x7fff
#define ORPGVCP_EXPERIMENTAL_VCP		  0x8000
...
int	ORPGVCP_get_sample_resolution    (int vcp_num);
int	ORPGVCP_set_sample_resolution    (int vcp_num, int res);
int	ORPGVCP_get_dbz_range_resolution (int vcp_num);
int	ORPGVCP_set_dbz_range_resolution (int vcp_num, int res);
int	ORPGVCP_get_dpl_range_resolution (int vcp_num);
int	ORPGVCP_set_dpl_range_resolution (int vcp_num, int res);
int	ORPGVCP_get_radial_resolution    (int vcp_num);
int	ORPGVCP_set_radial_resolution    (int vcp_num, int res);
