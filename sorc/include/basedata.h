 ...
 * $Author: cmn $
 * $Locker:  $
 * $Date: 2007/09/18 13:47:08 $
 * $Id: basedata.h,v 1.69 2007/09/18 13:47:08 cmn Exp $
 * $Revision: 1.69 $
 * $State: Exp $
 * $Log: basedata.h,v $
...
typedef struct {
    ...
    short msg_len;		/* message size in shorts. */
    ...
    short spare3;               /* Ununsed. */

    short no_moments;           /* Number of offsets to additional moments
                                   that follow. */

    unsigned short offsets[17];  /* Offsets to additional moments.  Offsets are 
...
#define RADIAL_TYPE_MASK           0x0f00
