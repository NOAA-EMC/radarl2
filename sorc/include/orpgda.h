 ...
 * $Author: jing $
 * $Locker:  $
 * $Date: 2006/01/04 22:15:18 $
 * $Id: orpgda.h,v 1.33 2006/01/04 22:15:18 jing Exp $
 * $Revision: 1.33 $
 * $State: Exp $
 */
...
int ORPGDA_copy_to_lb(const char* dest_lb, int src_data_id, int copy_flags);
int ORPGDA_copy_from_lb(int dest_data_id, const char* src_lb, int copy_flags);
int ORPGDA_copy(int dest_data_id, int src_data_id, int copy_flags);
int ORPGDA_copy_msg(int dest_data_id, int dest_msg_id, int src_data_id, int src_msg_id, int replace_existing);
