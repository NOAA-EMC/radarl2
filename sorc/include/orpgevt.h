 ...
 * $Author: steves $
 * $Locker:  $
 * $Date: 2007/07/12 22:12:17 $
 * $Id: orpgevt.h,v 1.107 2007/07/12 22:12:17 steves Exp $
 * $Revision: 1.107 $
 * $State: Exp $
 */
...
/** Event posted upon receipt of console message from RDA.
  *
  * POSTED BY: cpc004 tsk003 control_rda
  */
#define ORPGEVT_RDA_CONSOLE_MSG         110
...
typedef struct {
   ...
   short elev_num;		/* Elevation number */
