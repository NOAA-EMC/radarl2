 ...
 * $Author: cmn $
 * $Locker:  $
 * $Date: 2007/09/19 15:06:24 $
 * $Id: prod_user_msg.h,v 1.65 2007/09/19 15:06:24 cmn Exp $
 * $Revision: 1.65 $
 * $State: Exp $
 */  
...
typedef struct {		/* General Status Message */
    Pd_msg_header mhb;		/* message header block */
    short divider;		/* block devider = -1 */
    short length;		/* block length = 82: Number of bytes to 
				   follow */
    ...
    short ref_calib;		/* reflectivity calibration correction 
