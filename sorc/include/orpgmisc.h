 ...
 * $Author: cmn $
 * $Locker:  $
 * $Date: 2007/08/27 12:28:08 $
 * $Id: orpgmisc.h,v 1.32 2007/08/27 12:28:08 cmn Exp $
 * $Revision: 1.32 $
 * $State: Exp $
 */
...
#define LDM_VERSION_1	1	/* Message 1  - Legacy (Evansville - KVWX). */
#define LDM_VERSION_2	2	/* Message 31 - Legacy (SuperRes disabled). */
#define LDM_VERSION_3	3	/* Message 31 - SuperRes. */
#define LDM_VERSION_4	4	/* Message 31 - Recombined. */
