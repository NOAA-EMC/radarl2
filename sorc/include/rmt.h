 ...
 * $Author: jing $
 * $Locker:  $
 * $Date: 2007/05/14 18:59:03 $
 * $Id: rmt.h,v 1.40 2007/05/14 18:59:03 jing Exp $
 * $Revision: 1.40 $
 * $State: Exp $
 */
...
#define STATIC_BUFFER 2048	/* static buffer size for messages */
