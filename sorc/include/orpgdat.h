 ...
 * $Author: cmn $
 * $Locker:  $
 * $Date: 2007/11/20 16:22:18 $
 * $Id: orpgdat.h,v 1.156 2007/11/20 16:22:18 cmn Exp $
 * $Revision: 1.156 $
 * $State: Exp $
 */
...
#define ORPGDAT_GSM_DATA        ORPGDAT_RDA_STATUS
	...
	/* SMI_struct RDA_status_t ORPGDAT_GSM_DATA.RDA_STATUS_ID;
	   ...
	   SMI_struct ArchIII_status_t ORPGDAT_GSM_DATA.ARCHIII_STATUS_ID; */
...
#define ORPGDAT_BDDS_STATUS            3055
                                /* contains the data that is used to    *
                                 * status information across hci and    *
                                 * bdds  				*/
#define ORPGDAT_BDDS_COMMANDS          3057
                                /* contains BDDS commands.              */

#define ORPGDAT_WBSERVER               3058
                                /* contains WBserver data.              */

#define	ORPGDAT_RECOMBINED_RAWDATA	53
...
#define	ORPGDAT_HCI_DATA	3099
   ...
   SMI_struct Hci_password_t   ORPGDAT_HCI_DATA.HCI_PASSWORD_INFO_MSG_ID;
